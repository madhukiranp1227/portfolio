    ...
    <section id="hero" className="hero">
      ...
      <div className="container hero-content">
        <div className="hero-text">
          ...
          <h1 className="hero-name reveal" style={{ transitionDelay: '80ms' }}>Your Name</h1>
          ...
          <p className="hero-desc reveal" style={{ transitionDelay: '240ms' }}>
            I build robust, scalable full-stack applications using <strong>Java</strong> &amp; <strong>Spring Boot</strong> on the backend and <strong>React</strong> on the frontend.
            Passionate about clean architecture, REST APIs, and delivering great user experiences.
          </p>
        ...
        <div className="hero-avatar reveal" style={{ transitionDelay: '200ms' }}>
          <div className="avatar-ring">
            <div className="avatar-img">
              <span>YN</span>
            </div>
          </div>
          <div className="floating-badge badge1">Spring Boot</div>
          <div className="floating-badge badge2">Java</div>
          <div className="floating-badge badge3">React</div>
        </div>
      </div>
